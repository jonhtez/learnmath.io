<?php
    ...
    // $sql = "SELECT * FROM activities WHERE category = '$cat'";
    // $result = $conn->query($sql);
        ...
        <div class="row" style="align-items: center;">
            <div class="col-md-6">
                <div style="padding:30px; text-align:center;">
                    ...
                    <p style="color:white;">This is the session that will test the pupils counting skills. There are different exercises and questions for the student.</p>
        ...
        <div class="row" style="align-items: center;">
            ...
            <div class="col-md-7">
                <div style="padding:20px;">
                    ...
                    <p style="color:white;">Learn Mathematics is helping the pupils learn and develop their interest in mathematics; 
                    introducing mathematics in a different way that is much more fun and interactive will change the pupils' perspective 
                    towards mathematic as a subject and hence improve their grades in school.<br><br>
                ...
                <div class="col-md-3">
                    <div class="card" style="background:#eb68ff; color:white; margin-bottom:20px;">
                        <div class="card-body">
                            ...
                            <p class="card-text">This is the class suitable for classX to classY with relevant curriculum. Subscribe to the class now</p>
