...
?>
    ...
    <div class="container" style="padding:0; background:#eb68ff;">
        <div class="row" style="align-items: center;">
            <div class="col-md-6">
                <div style="padding:30px; text-align:center;">
                    <h1 class="align-middle head-title" style="color:white;">Class One</h1>
                    <p style="color:white;">This is the category for the pupils in the year 1-2 in school and the curriculum has been designed with their general school lesson note </p>
        ...
        <div class="row" style="align-items: center;">
            ...
            <div class="col-md-7">
                <div style="padding:20px;">
                    ...
                    <!-- <a href="classroom.php?cat=Class 1"><button class="btn take-class-btn" style="background:#eb68ff;">Enter Class for the week</button></a> -->
                    <div class="row">
                    <?php
                        foreach($rows as $row)
                            {
                    ?>
                        ...
                        <div class="col-md-9">
                            <p><a href="classroom.php?cat=Class 1&id=<?php echo $row["id"];?>"><?php echo $row["topic"];?></p></a>
                        </div>
