...
?>
    ...
    <div class="container" style="padding:0; background:#0098ff;">
        <div class="row" style="align-items: center;">
            <div class="col-md-6">
                <div style="padding:30px; text-align:center;">
                    <h1 class="align-middle head-title" style="color:white;">Class Three</h1>
                    <p style="color:white;">This is the category for the pupils in the year 6-8 in school and the curriculum has been designed with their general school lesson note </p>
        ...
        <div class="row" style="align-items: center;">
            ...
            <div class="col-md-7">
                <div style="padding:20px;">
                    ...
                    <!-- <button type="submit" class="btn take-class-btn" style="background:#0098ff;">Enter Class for the week</button> -->
                    <div class="row">
                    <?php
                        foreach($rows as $row)
                            {
                    ?>
                        ...
                        <div class="col-md-9">
                            <p><a href="classroom.php?cat=Class 3&id=<?php echo $row["id"];?>"><?php echo $row["topic"];?></p></a>
                        </div>
