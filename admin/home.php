...
?>
 ...
 <div class="container c-ban2" style="margin-top:0px;">
        <div style="text-align:center; padding:30px 0;">
            <h3 class="head-title2" style="color:white;">Admin Panel</h3>
                ...
                <div class="col-md-4">
                    <div class="card" style="margin-bottom:20px;">
                        <div class="card-body">
                            ...
                            <a href="pupils.php" class="btn" style="background:#ff3b00; color:white;">List</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card" style="margin-bottom:20px;">
                        <div class="card-body">
                            ...
                            <a href="lessons.php" class="btn" style="background:#ff3b00; color:white;">List</a>  <a href="lesson_add.php" class="btn" style="background:#ff3b00; color:white;">+Add</a>
                        </div>
                    </div>
                </div>
