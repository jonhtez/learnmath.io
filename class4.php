...
?>
    ...
    <div class="container" style="padding:0; background:#7c6cc6;">
        <div class="row" style="align-items: center;">
            <div class="col-md-6">
                <div style="padding:30px; text-align:center;">
                    <h1 class="align-middle head-title" style="color:white;">Class Four</h1>
        ...
        <div class="row" style="align-items: center;">
            ...
            <div class="col-md-7">
                <div style="padding:20px;">
                    ...
                    <!-- <button type="submit" class="btn take-class-btn" style="background:#7c6cc6;">Enter Class for the week</button> -->
                    <div class="row">
                    <?php
                        foreach($rows as $row)
                            {
