...
<script>
    ...
    <div style="width:400px; background:#3498db; margin:auto; border-radius:8px; padding:20px; margin-top:70px;">
        <h3 class="head-title2" style="color:white; text-align:center; padding-bottom:30px;">Teacher/modulator login</h3>
